...
// `useGalleryData.js` used to be byte-identical local copies of what ceramics
...
// legacy project key, no UUID — ceramics shares the same entity list and
...
export const itemSheet = {
  ...
  related: {
    ...
    // Since inventory-app#1807 (ceramics-data 1.0.11+), an outside

...
export default {
  ...
  home: {
    title: 'ceramics.identity.title',
    intro: 'ceramics.home.intro',
    cards: [
      {
        title: 'ceramics.nav.catalogue',
        description: 'ceramics.home.catalogueText',
    ...
    featured: {
      entity: 'items',
      heading: 'ceramics.home.itemOnDisplay',
  ...
  navigation: {
    ...
    links: [
      ...
      { section: 'catalogue', label: 'ceramics.nav.catalogue', to: { name: 'catalogue' } },
      { section: 'about', label: 'ceramics.nav.about', to: { name: 'about' } },
    ],
  },
  ...
  //
  //   extraViews: [
  //     ...standardRoutes('gallery', { creditsBody: 'ceramics.credits.body' }),
  ...
  //       partnerObjects: {
  //         emptyPartner: 'ceramics.partnerObjects.emptyPartner',
  //         emptyInstitution: 'ceramics.partnerObjects.emptyInstitution',
  //         institutionSummary: 'ceramics.partner.monumentsInExhibition',
  //         partnerProfileLabel: 'ceramics.partnerObjects.partnerProfile',
  //         institutionProfileLabel: 'ceramics.partnerObjects.institutionProfile',
  //       },
  //     }),
  //     // + this website's own routes: home, item, collection entrance,
  //     // timeline entrance, partners entrance

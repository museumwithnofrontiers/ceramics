...
The **Museum With No Frontiers — Ceramics** gallery, built from the published
dataset `@museumwnf/ceramics-data`.
...
| Package | Role |
| --- | --- |
| `@museumwnf/ceramics-data` | the dataset (JSON + `manifest.json`) |
...
<https://museumwithnofrontiers.github.io/ceramics/> through the reusable workflows in
